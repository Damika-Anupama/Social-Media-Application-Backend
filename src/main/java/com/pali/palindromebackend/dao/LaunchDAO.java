...
public interface LaunchDAO extends JpaRepository<Launch,Integer> {
    ...
    @Query("select new com.pali.palindromebackend.entity.Launch (" +
            "l.id," +
            "l.media," +
            "l.mediaType," +
            "l.description," +
    ...
    @Query("select new com.pali.palindromebackend.entity.custom.LaunchUserDetails (l.id,l.media,l.mediaType,l.description,l.feeling,u.id,u.username,u.shortDescription,u.profilePicture,u.onlineStatus,l.updatedDate,l.createdDate) from Launch l join l.user u")
